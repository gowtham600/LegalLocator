          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              <div className="flex items-center">
                ...
                <span className="text-sm font-mono">30km (Primary)</span>
              </div>
              <div className="flex items-center">
                <div className={`h-3 w-3 rounded-full ${!isPrimary ? 'bg-accent' : 'bg-gray-300'} mr-2`}></div>
                <span className="text-sm font-mono">60km (Extended)</span>
              </div>
            </div>
          </div>
          <div className="mt-4 relative h-40 bg-background rounded-lg border border-gray-200 overflow-hidden">
            <div className="absolute inset-0 flex items-center justify-center">
              ...
              <div className="relative">
                ...
                <div className={`absolute rounded-full ${!isPrimary ? 'bg-accent/10 border-accent' : 'bg-gray-100 border-gray-200'} w-80 h-80 border`}></div>
